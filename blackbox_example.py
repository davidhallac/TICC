...
results = RunTicc(fname, "Results.txt", input_format='matrix', logging_level=log_level, cluster_number=[2,3,4])
...
results2 = RunTicc(fname2, "Results.txt", input_format='graph', delimiter='\t', logging_level=log_level, cluster_number=[2,3,4])
